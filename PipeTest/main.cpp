...
void parentTask()
{
    ...
    else
    {
        ...
        {
            std :: cout << "The message received from the child is: " << message;
        }
...
int main()
{
    ...
    else
    {
        ...
        int canBeRemoved = remove( "ReadFromConsole" );
        /// after finishing using the fifo file it must be removed in order to create it again when rerunning the program
